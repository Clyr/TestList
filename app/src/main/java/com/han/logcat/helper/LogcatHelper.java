package com.han.logcat.helper;


import com.han.logcat.util.UtilLogger;
...
public class LogcatHelper {
	...
	public static final String BUFFER_MAIN = "maincatlog";
	...
	private static List<String> getLogcatArgs(String buffer) {
		...
		// for some reason, adding -b maincatlog excludes log output from AndroidRuntime runtime exceptions,
		// whereas just leaving it blank keeps them in.  So do not specify the buffer if it is "maincatlog"
