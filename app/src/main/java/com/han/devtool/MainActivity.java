...
import com.han.RomUtil;
import com.han.SettingsCompat;
...
import com.han.logcat.helper.SuperUserHelper;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fpsmain);
    ...
    protected void onResume() {
        super.onResume();
        if (!SettingsCompat.checkAlertWindowsPermission(this)) {
