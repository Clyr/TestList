 ...
 *
 */
public class HuaweiPushRevicer2 extends PushReceiver {
    ...
    public void onToken(Context context, String tokenIn, Bundle extras) {
        ...
        ToastUtils.showLong("belongId is:" + belongId + " Token is:" + tokenIn);
        MyLog.d("belongId is:" + belongId + " Token is:" + tokenIn);
        callBack(intent);
    }
