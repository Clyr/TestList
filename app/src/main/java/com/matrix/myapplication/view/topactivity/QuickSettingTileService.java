...
public class QuickSettingTileService extends TileService {
    public static final String ACTION_UPDATE_TITLE = "com.matrix.myapplication.ACTION.UPDATE_TITLE";
    ...
    public void onTileAdded() {
        ...
        sendBroadcast(new Intent(TopMainActivity.ACTION_STATE_CHANGED));
    }
    ...
    public void onClick() {
        if (WatchingAccessibilityService.getInstance() == null || !Settings.canDrawOverlays(this)) {
            ...
            intent.putExtra(TopMainActivity.EXTRA_FROM_QS_TILE, true);
