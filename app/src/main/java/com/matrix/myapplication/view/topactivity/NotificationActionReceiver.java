...
public class NotificationActionReceiver extends BroadcastReceiver {
    ...
    public static final String ACTION_NOTIFICATION_RECEIVER = "com.matrix.myapplication.ACTION_NOTIFICATION_RECEIVER";
    ...
    public static void showNotification(Context context, boolean isPaused) {
        ...
        PendingIntent pIntent = PendingIntent.getActivity(context, 0, new Intent(context, TopMainActivity.class), 0);
