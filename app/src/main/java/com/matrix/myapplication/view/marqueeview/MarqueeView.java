package com.matrix.myapplication.view.marqueeview;
...
public class MarqueeView extends ViewFlipper {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (typedArray.hasValue(com.sunfusheng.marqueeview.R.styleable.MarqueeViewStyle_mvTextSize)) {
            ...
            textSize = com.sunfusheng.marqueeview.Utils.px2sp(context, textSize);
        }
    ...
    private void startWithFixedWidth(String notice, @AnimRes int inAnimResId, @AnimRes int outAnimResID) {
        ...
        int width = com.sunfusheng.marqueeview.Utils.px2dip(getContext(), getWidth());
        if (width == 0) {
    ...
    public void startWithList(List<? extends CharSequence> notices, @AnimRes int inAnimResId, @AnimRes int outAnimResID) {
        if (com.sunfusheng.marqueeview.Utils.isEmpty(notices)) return;
        setNotices(notices);
        postStart(inAnimResId, outAnimResID);
    }
