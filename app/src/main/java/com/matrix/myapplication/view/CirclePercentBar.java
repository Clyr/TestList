...
import com.matrix.myapplication.utils.DisplayUtil;
...
public class CirclePercentBar extends View {
    ...
    public CirclePercentBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mArcColor = typedArray.getColor(R.styleable.CirclePercentBar_arcColor,R.color.green_blue);
        ...
        arcStartColor = typedArray.getColor(R.styleable.CirclePercentBar_arcStartColor,
                ContextCompat.getColor(mContext, R.color.green_blue));
    ...
    private void initPaint() {
        ...
        arcCirclePaint.setColor(ContextCompat.getColor(mContext,R.color.gray_ll));
