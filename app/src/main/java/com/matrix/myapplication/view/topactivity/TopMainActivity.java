package com.matrix.myapplication.view.topactivity;
...
public class TopMainActivity extends Activity implements OnCheckedChangeListener {
    public static final String EXTRA_FROM_QS_TILE = "from_qs_tile";
    public static final String ACTION_STATE_CHANGED = "com.matrix.myapplication.ACTION_STATE_CHANGED";
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setNegativeButton(android.R.string.cancel
                                , new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        SPHelper.setIsShowWindow(TopMainActivity.this, false);
                                        refreshWindowSwitch();
                                    }
                                })
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton(R.string.dialog_enable_accessibility_positive_btn
                                , new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        SPHelper.setIsShowWindow(TopMainActivity.this, true);
