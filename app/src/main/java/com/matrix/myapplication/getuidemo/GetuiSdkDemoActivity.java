package com.matrix.myapplication.getuidemo;
 ...
 * log 提示.
 */
public class GetuiSdkDemoActivity extends BaseActivity implements OnClickListener {
    ...
    //TODO 添加 设置
    /*应用名称：	TestList
    appId：	QKcikwnq0w6kpjsrDs2iS3
    appSecret：	g8S7kNB5DS7q5CrFRJbkh
    appKey：	Daf4RF45yl50q1oYr33962
    应用包名：	com.matrix.myapplication
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.getuimain);
