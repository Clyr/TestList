package com.matrix.myapplication.utils.mail;
...
public class SendMailUtil {
    ...
    private static final String FROM_ADD = "TestList2019@163.com";
    private static final String FROM_PSW = "TestList123456";
////    private static final String TO_ADD = "2584770373@qq.com";
    ...
    private static MailInfo creatMail(String toAdd, String msg) {
        ...
        mailInfo.setFromAddress(FROM_ADD); // 发送的邮箱
        mailInfo.setToAddress(toAdd); // 发到哪个邮件去
        mailInfo.setSubject("华为Push token"); // 邮件主题
